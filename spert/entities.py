...
class Dataset(TorchDataset):
    ...
    def create_document(self, doc_id, tokens, entity_mentions, subtype_mentions, relations, sent_labels, word_piece_labels, doc_encoding) -> Document:
        document = Document( \
                        doc_id = doc_id,
                        doc_index = self._doc_id,
                        tokens = tokens,
