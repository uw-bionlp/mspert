...
class SpERT(BertPreTrainedModel):
    ...
    def _forward_inference(self, encodings: torch.tensor, context_masks: torch.tensor, entity_masks: torch.tensor, entity_masks_adj: torch.tensor,
        ...
        self.entity_classifier.eval()
        self.sent_classifier.eval()
        self.word_piece_classifier.eval()
        for layer_name, subtype_classifier in self.subtype_classifiers.items():
            subtype_classifier.eval()
        ...
        del context_masks, h, batch_size, ctx_size, cls_embedding, size_embeddings, entity_ctx
        del entity_spans_pool, rel_masks, rel_sample_masks, h_large, chunk_rel_logits, chunk_rel_clf
    ...
    def _classify_entities(self, h, entity_masks, entity_masks_adj, size_embeddings, entity_ctx):
        ...
        del m, entity_spans_pool_adj, entity_ctx, entity_repr, subtype_repr
    ...
    def _classify_relations(self, entity_spans, size_embeddings, relations, rel_masks, h, chunk_start):
        ...
        del batch_size, relations, rel_masks, h, entity_pairs, size_pair_embeddings, m, rel_ctx, rel_repr
