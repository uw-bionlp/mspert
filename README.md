# mSpERT: Medical Span-based Entity and Relation Transformer
This is a UW-bioNLP update to SpERT: ["Span-based Entity and Relation Transformer"](https://github.com/lavis-nlp/spert). 

Similar to our [fork of the original SpERT](https://github.com/uw-bionlp/spert), the repo is largely for **inference** convenience. For training a new model, please refer to <add_training_repo>. 
